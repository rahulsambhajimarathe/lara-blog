...
<head>
  ...
  <link href="{{ url('ssets/admin/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" name="terms" type="checkbox" id="acceptTerms" required value="true">
